...
const dbPath = path.join(appData, 'school-management-system', 'school-replica.db');
...
async function run() {
  console.log(`Loading real DB from: ${dbPath}`);
  ...
  console.log("\nMAIN DB Migration completed successfully!");
}
