...
const startIndex = code.indexOf('function renderNavEnhanced() {');
const endIndex = code.indexOf('// Intercept renderNav calls');

if (startIndex !== -1 && endIndex !== -1) {
  code = code.substring(0, startIndex) + newRenderNavEnhanced + '\n\n' + code.substring(endIndex);
  fs.writeFileSync('public/app.js', code);
  console.log("Sidebar patched with Lordicons and smart DOM updates.");
} else {
  console.log("Could not find renderNavEnhanced or Intercept renderNav calls string!");
}
