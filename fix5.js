...
const replacement = `function renderAnalyticsCharts(store) {
  ...
  grid.style.display = "grid"; // or whatever the default display is
  grid.innerHTML = "";
